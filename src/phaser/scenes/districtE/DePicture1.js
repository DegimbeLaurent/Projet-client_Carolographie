var DePicture1 = new Phaser.Class({
    Extends: PicturesTemplate,
    initialize: function(config){
        Phaser.Scene.call(this, {"key":"DePicture1"});
    },
    init: function(){
        playerMap = [];
    },
    ...
    create: function(config){
        ...
        //==========================================
        this.add.text(400, 200, "DISTRICT EST - PICTURE 1", {fontFamily: "Arial Black",fontSize: 36});
        this.add.text(400, 250, "xxx", {fontFamily: "Arial Black",fontSize: 36});
        //==========================================
        ...
        // }, this);      
        let btn = this.createButtonReturnRoom(this, "DeRoom");
        //==========================================

var DcPicture2 = new Phaser.Class({
    Extends: PicturesTemplate,
    initialize: function(config){
        Phaser.Scene.call(this, {"key":"DcPicture2"});
    },
    init: function(){
        playerMap = [];
    },
    ...
    create: function(config){
        ...
        //==========================================
        this.add.text(400, 200, "DISTRICT CENTRE - PICTURE 2", {fontFamily: "Arial Black",fontSize: 36});
